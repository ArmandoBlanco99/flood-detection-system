...
from Realtime import (
    predecir_alerta_con_coordenadas,
    validar_coordenadas_cdmx,
    LATITUD_FIJA,
    LONGITUD_FIJA,
)
import logging
...
coordenadas_actuales = {"latitud": LATITUD_FIJA, "longitud": LONGITUD_FIJA}
...
def ingest():
    ...
    if isinstance(v, (int, float)) and isinstance(pct, (int, float)):
        ...
        resultado = predecir_alerta_con_coordenadas(
            coordenadas_actuales["latitud"], coordenadas_actuales["longitud"], nivel_sensor
        )
